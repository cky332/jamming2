...
复用：
    from deepseek_v32_client import call_deepseek, make_openai_client
    text, usage = call_deepseek("你的 prompt")
    client = make_openai_client()   # 返回 openai.OpenAI 实例，base_url 已指向 SiliconFlow
"""
...
def make_openai_client():
    """返回一个指向 SiliconFlow 的 openai.OpenAI 实例，供 medagent 等模块直接复用。"""
...
if __name__ == "__main__":
    ...
    # V3.2 大致单价：~¥2/M input, ~¥8/M output

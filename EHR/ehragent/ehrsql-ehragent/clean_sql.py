...
def sql_interpreter(command):
    con = sqlite3.connect("{}/{}.db".format(DATASET, DATASET))
    cur = con.cursor()
    try:
...
file_path = "{}/valid.json".format(DATASET)
# read from json file
...
output_file_path = "{}/valid_filtered_20240104.json".format(DATASET)
with open(output_file_path, 'w') as f:
    json.dump(new_contents, f)

output_file_path = "{}/valid_filtered_20240104.jsonl".format(DATASET)
